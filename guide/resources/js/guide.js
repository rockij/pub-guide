...
snbLinks.forEach((button) =>
    button.addEventListener('click', snbEvent.snbLink)
);
snbEvent.snbToggle();
    ...
    sort(ascending, columnClassName, tableId) {
        ...
        while (unsorted) {
            ...
            for (let r = 0; r < rows.length - 1; r++) {
                ...
                let value =
                    row.getElementsByClassName(columnClassName)[0].innerHTML;
                let nextValue =
                    nextRow.getElementsByClassName(columnClassName)[0]
                        .innerHTML;
