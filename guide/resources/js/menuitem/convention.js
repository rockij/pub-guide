let convention = [
  ...
  <h3>1.2 코딩 컨벤션 요소</h3>
  <h4><a href="#convention2">1.2.1 네이밍규칙</a></h4>
  <h4><a href="#convention3">1.2.2 기본 공통 규칙</a></h4>
  ...
  <h4>A. 일반 규칙</h4>
  이름은 영문 소문자, 숫자, 언더스코어(_)로 작성한다.<br/>
  공통관리는 더블언더스코어(__)로 작성한다.<br/>
  ...
  <ul>
      ...
      <li>네이밍을 지을땐 '역할_형태_타입' 형태로 한다.(form__group_row)</li>
      <li>단어는 의미를 알수 있도록하며 3뎁스를 넘기지 않는다.(btn__m_info)</li>
  </ul>
  <table class="table2">
      <colgroup>
      <col width="30%">
      ...
      <tr>
          ...
          <td>
          script 작업 등 기능적인 요소만을 추가해야 할 경우 단어 사이에 라인을 붙인다.
          </td>
      </tr>
      <tr>
          <td>종속확장</td>
  ...
  <ul>
      ...
      <li>수정사항 표시는 '날짜_수정내용'로 조합한다. (230612_문구수정)</li>  
  </ul>
  ...
  <ul>
      ...
      <li>코드 작성시에는 접근성 반영을 기본으로 한다.</li>
      <li>주석달기는 <a href="#convention3">기본 공통 규칙 참고</a></li>
  </ul>
  <h3>5.2 jquery 라이브러리로 작업시</h3>
