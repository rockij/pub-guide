...
<div id="mw-popup1" role="dialog" class="popup_wrap" data-popup-type="center">
  <div class="popup_back" aria-hidden="true" onclick="POPUP_EVENT.close('popup1', 'popup1', 0)"></div>
  <div class="popup_container">
    <div class="popup_content">
      팝업내용1      
    </div>
    <button onclick="POPUP_EVENT.close('popup1','popup1',0)">확인</button>
    <button class="popup_close" onclick="POPUP_EVENT.close('popup1', 'popup1',0)">팝업닫기</button>
  </div>  
</div>
    `,
...
<div id="mw-popup2" role="dialog" class="popup_wrap" data-popup-type="bottom">
  <div class="popup-close popup_back" aria-hidden="true" onclick="POPUP_EVENT.close('popup2','popup2',0)"></div>
  <div class="popup_container">
    <div class="popup_content">
      팝업내용
    </div>
    <button class="" onclick="POPUP_EVENT.open('popup2',1)">확인</button>
    <button class="popup_close" onclick="POPUP_EVENT.close('popup2','popup2',0)">팝업닫기</button>
  </div>  
</div>
    `,
...
<div id="mw-popup3" role="dialog" class="popup_wrap" data-popup-type="full">
  <div class="popup_container">
    ...
    <button class="popup_close" onclick="POPUP_EVENT.close('popup3','popup3',0)">팝업닫기</button>
  </div>  
</div>
    `,
