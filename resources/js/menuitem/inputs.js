let inputs = [
    {
        ...
        tag_text: `
<ul class="list--type">
<li>입력시 label을 사라지게 하기 위해 INPUT_OPTION.labelControl('input--label'); 실행</li>
<li>입력한 값을 삭제하기 위해 INPUT_OPTION.inputRemove('input--del'); 실행</li>
</ul>
    `,
        tag_html: `
<div role="group" class="form--group">
    <div class="form--area_col">
        <span class="label-name">이름</span>
        <div class="input-area">
            <div class="input--box input--label input--del">
                <input type="text" class="input" id="input-text-default" />
                <label for="input-text-default" class="input-label">Text</label>
                <div class="unit_set">
                    <button type="button" class="btn-del" title="입력텍스트 삭제">del</button>
                </div>
            </div>
        </div>
    </div>
...
[class*="input--box"] .input-label{position:absolute;left:10px;top:10px;font-size:14px;color:var(--color-secondary2);transition-duration:var(--transition-speed)}
[class*="input--box"] input.focus + .input-label,
[class*="input--box"] textarea.focus + .input-label{display:none}
[class*="input--box"] input[readonly]{color:var(--bg-base)}
...
.form--area_col .label-name{flex:0 0 140px;padding-top:10px;font-size:14px}
...
.form--area_row .label-name{display:block;margin-bottom:10px;font-size:14px}
.form--area_row .input--box_ani input:focus + .input-label{transform:translateY(calc(var(--input-height) * -1))}
    ...
    },
    {
        ...
        tag_text: `
<ul class="list--type">
<li>입력한 값을 복사하기 위해 INPUT_OPTION.textCopy('input--copy'); 실행</li>
</ul>
    `,
        tag_html: `
<div class="input--box input--label input--copy">
    <input type="text" class="input" id="input-text-copy" />
    <label for="input-text-copy" class="input-label">Text</label>
    <div class="unit_set">
    ...
    },
    {
        ...
        tag_text: `
<ul class="list--type">
<li>입력하는 값을 크기 체크를 위해 INPUT_OPTION.inputMaxlength('input--maxlength'); 실행</li>
<li>
    <strong>설명</strong>
    <ol>
    ...
    `,
        tag_html: `
<div class="input--box input--label input--maxlength">
    <input type="text" class="input" id="input-text-maxlength" maxlength="16" aria-describedby="inputMessage" />
    <label for="input-text-maxlength" class="input-label">입력수제한</label>
    <div class="unit_set">
...
<li>aria-describedby의 값과 에러 문구를 나타내는 태그의 id값을 일치</li>
    ...
    `,
        tag_html: `
<div class="input--box input--label">
    <input type="text" class="input" id="input-text-error" aria-describedby="error-msg" />
    <label for="input-text-error" class="input-label">Text(error)</label>
</div>
<p id="error-msg" class="input--msg_error">에러메세지</p>
        `,
    },
    {
        number: 5,
...
<div class="input--box input--label">
    ...
    <label for="input-text-readonly" class="input-label">readonly</label>
</div>
        `,
    },
    {
...
<div class="input--box input--label">
    ...
    <label for="input-text-disabled" class="input-label">disabled</label>
</div>
        `,
    },
    {
...
<div class="input--box input--label">
    ...
    <label for="input-text-focuswithinx" class="input-label">focus-within(x)</label>
    <i class="border"></i>        
</div>
        `,
    },
...
<div class="input--box input--label">
    ...
    <label for="input-text-aria-describedby" class="input-label">text</label>
    </div>
</div>
        `,
    },
...
<ul class="list--type">
<li>입력된 텍스트를 선택한다.</li>
<li>실행: INPUT_OPTION.textSelectAll('input--select');</li>
</ul>
`,
tag_html: `
<div class="input--box input--label input--select">
    <input type="text" class="input" id="input-text-select" value="입력된 텍스트가 선택됨" />
    <label for="input-text-select" class="input-label">text</label>
</div>
        `,
    },
    {
...
<div class="input--box input--label">
    ...
    <label for="input-email" class="input-label">이메일 주소 입력</label>
</div>
        `,
    },
    {
        ...
        tag_text: `
<ul class="list--type">
<li>입력한 비밀번호 보기 기능 추가 필요시 INPUT_OPTION.passToggle('input--pw-toggle'); 실행</li>
</ul>
    `,
        tag_html: `
<div class="input--box input--label input--pw-toggle">
    <input type="password" class="input" id="input-pass" />
    <label for="input-pass" class="input-label">비밀번호 입력</label>
    <div class="unit_set">
...
<div class="input--box">
    ...
    <label for="input-number" class="input-label">number</label>
</div>
        `,
    },
    {
...
<div class="input--box">
    ...
    <label for="input-tel" class="input-label">tel</label>
</div>
        `,
    },
    {
...
<div class="input--box">
    ...
    },
    {
        ...
        tag_text: `
<ul class="list--type">
<li>label의 위치 세로인 형태 움직임을 주려면 input--box_ani로 한다.</li>
</ul>
    `,
        tag_html: `
<div class="form--area_row">
    <span class="label-name">Text</span>
    <div class="input-area">
        <div class="input--box input--label">
        <input type="text" class="input" id="input-text-row" />
        <label for="input-text-row" class="input-label">Text</label>
        </div>
    </div>
</div>
<br/>
<div class="form--area_row">
    <div class="input-area">
        <div class="input--box_ani input--label">
        <input type="text" class="input" id="input-text-row2" />
        <label for="input-text-row2" class="input-label">Text</label>
        </div>
    </div>
</div>
        `,
...
<div class="input--box input--label">
    ...
    <label for="input-textarea" class="input-label">Textarea</label>
</div>
    `,
    },
    {
...
<li>입력한 글자수에 따라 세로 길이를 조절해야할 경우 INPUT_OPTION.autoResize('textarea--autosize', 83); 실행</li>
</ul>
    `,
        tag_html: `
<div class="input--box input--label input--maxlength textarea--autosize">
    <textarea id="input-textarea2" cols="30" rows="5" class="input" maxlength="100" aria-describedby="textareaMessage"></textarea>
    <label for="input-textarea2" class="input-label">Textarea</label>
    <div class="unit_set">
...
<div class="field--multi_columns">    
    ...
    `,
        tag_css: `
.field--multi_columns{display:flex;flex-direction:row;gap:15px}
...
<li>앞자리 6자리 입력 후 뒤 1자리만 입력하는 양식</li>
    ...
    `,
        tag_html: `
<div class="field--multi_registnum">    
    <div class="input-area">
        <div class="input--box">
            <input type="tel" class="input" maxlength="6" id="jumin1" />
            <label for="jumin1" class="input-label">앞 6자리</label>
        </div>        
    </div>
    <div class="input-area input_backnum">
        <div class="input--box">
...
<p id="registnum-error-msg" class="input--msg_error">에러메세지</p>
        `,
        tag_css: `
.field--multi_registnum{display:flex;flex-direction:row;gap:15px}
.field--multi_registnum .input-area{flex:1}
.field--multi_registnum .input_backnum input{flex:0;width:30px;padding:0;text-align:center}
.field--multi_registnum .input_backnum .icon_pw{
...
<li>앞주소 입력 후 뒷자리는 입력 혹은 선택할 수 있는 양식</li>
    ...
    `,
        tag_html: `
<div class="field--multi_email">    
    <div class="input-area">
        <div class="input--box input--label">
            <input type="text" class="input" id="email-address" maxlength="3" />
            <label for="email-address" class="input-label">email id</label>
        </div>
    </div>
    <div class="input-area input_remain">
        <div class="input--box input--email-select">
        ...
        `,
        tag_css: `
.field--multi_email{display:flex;flex-direction:row;gap:15px}
.field--multi_email .input-area{flex:1}
.field--multi_email .input_remain{display:flex;align-items:center}
.field--multi_email .input_remain::before{content:'@';margin-right:15px}
.field--multi_email .input_remain .input--box{flex:1}
.field--multi_email .input_remain input{display:none;position:absolute;top:0;left:0;width:calc(100% - 40px);height:var(--input-height);background-color:#fff;border-radius:var(--border-radius)}
        `
    },
    {
        number: 21,
...
<div id="mw-calendar" role="dialog" class="popup-wrap popup_bodtfix" data-popup-type="bottom">
  <div class="popup-close popup-back" aria-hidden="true"></div>
  <div class="popup-container">
    ...
    <button class="popup-close">팝업닫기</button>
  </div>  
</div>
    `
    },
...
<li>실행: INPUT_OPTION.otpField('form--otp');</li>
</ul>
    `,
        tag_html: `
<div class="input--otp">
